...
int CVICALLBACK color2 			(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
int CVICALLBACK color 			(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
int CVICALLBACK Clearing2 		(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
...
void BuildGUI(void)
{
	...
	panel = NewPanel(0, "User 1",  VAL_AUTO_CENTER, ATTR_TOP , 500, 600);   
    ...
    InstallCtrlCallback (panel, quitButton, Shutdown, 0);			
